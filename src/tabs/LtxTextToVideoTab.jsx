...
import { startLtxTextToVideo } from '../api/pixazo';

const fields = [
  { key: 'prompt', label: 'Prompt', type: 'text', required: true, placeholder: 'Describe the video scene in detail…' },
...
export default function LtxTextToVideoTab({ apiKey }) {
  const polling = usePolling(apiKey);

  return (
    <AsyncForm
      title="LTX Text → Video"
      fields={fields}
      onStart={(form) => startLtxTextToVideo(apiKey, {
        ...form,
